...
(function(window, videojs) {
    ...
    videojs.plugin('ResolutionSelector', function(options) {
        ...
        if (current_res) {
            currentQualityLabel = createResolutionLabel(current_res);
            currentQualityCssClass = createResolutionCssClass(current_res);
        } else {
            currentQualityCssClass = createResolutionCssClass(360);
        }
        ...
        resolutionSelector = new videojs.ResolutionSelector( player, {
            el: videojs.Component.prototype.createEl( null, {
                ...
                //innerHTML  : '<div class="vjs-control-content"><span class="vjs-current-res">' + ( currentQualityLabel || 'Quality' ) + '</span></div>',

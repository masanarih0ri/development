...
<body>
	...
	<div class="fortune-text" id="fortune-text">
		...
		<p><?php echo htmlspecialchars($text1); ?></p>
		<p><?php echo htmlspecialchars($text2); ?></p>
		<p><?php echo htmlspecialchars($text3); ?></p>
		<p><?php echo htmlspecialchars($text4); ?></p>
		<p><?php echo htmlspecialchars($text5); ?></p>
		<p><?php echo htmlspecialchars($text6); ?></p>
	</div>
	<div class="others">
